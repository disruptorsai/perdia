...
export default function KanbanBoard({ ideas, articles, onStatusChange, isLoading, generatingIdeas = {}, onGenerateArticle }) {
  ...
  const handleDragEnd = (result) => {
    ...
    if (newStatus && item.type === 'article') {
                            ...
                            >
                              {item.type === 'generating' ? (
                                <GeneratingArticleCard
                                  ...
                                  onClick={() => {
                                    // Open generation detail view
                                    window.open(`${createPageUrl('GenerationProgress')}?ideaId=${item.id}`, '_blank');
                                  }}
                                />
                              ) : (
                                <ArticleCard
