...
Return ONLY the humanized HTML. No commentary.`;
      ...
      return { content: cleanedContent, faqs };
    },
    onSuccess: ({ content, faqs }) => {
  ...
  const generateContentMutation = useMutation({
    mutationFn: async () => {
      ...
      const humanizationPrompt = `Humanize this article to sound naturally written by an experienced education writer.

${result}

HUMANIZATION RULES:
✓ Vary sentence length dramatically
✓ Use contractions: don't, you'll, won't
✓ Add rhetorical questions naturally
✓ Start sentences with "And" or "But" occasionally
✓ Use em dashes — for emphasis
✓ Remove robotic phrases: "Furthermore", "Moreover", "It's worth noting"
✓ Address reader as "you"
✓ Mix formal and conversational tone appropriately
✓ Add specific examples over generic ones
✓ Sentence fragments. When appropriate.
✓ Keep all H2 headings and links unchanged

Return ONLY humanized HTML. No explanations.`;
