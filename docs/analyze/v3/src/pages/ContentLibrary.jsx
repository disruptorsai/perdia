      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage all your articles in one place</p>
          </div>
            ...
            filteredArticles.map((article, index) => (
              ...
              >
                <Link to={`${createPageUrl("ArticleEditor")}?id=${article.id}`}>
                  <Card className="p-6 hover:shadow-xl transition-all duration-300 cursor-pointer border-none shadow-lg group">
