  ...
  const generateSuggestions = () => {
    ...
    clusters.forEach(cluster => {
      allSuggestions.push({
        ...
        targetAudience: 'Prospective online students',
    ...
    // Sort by priority
    const priorityOrder = { high: 0, 5: 0, 4: 1, medium: 1, 3: 1, 2: 2, low: 2, 1: 2 };
    allSuggestions.sort((a, b) => (priorityOrder[a.priority] || 1) - (priorityOrder[b.priority] || 1));
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 flex-wrap mb-3">
                          ...
                          <Badge variant="outline" className="capitalize">
                            {typeof suggestion.priority === 'number' ? `Priority ${suggestion.priority}` : `${suggestion.priority} priority`}
                          </Badge>
                        </div>
