...
export default function WordPressSetupStep({ onNext, onPrevious, onSkip }) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      >
        <Card className="p-6">
          <div className="space-y-4">
            {/* URL Input */}
            <div>
              <Label htmlFor="wordpress-url" className="text-sm font-medium">
                WordPress Site URL *
              </Label>
              <Input
                id="wordpress-url"
      ...
      >
        <Button variant="ghost" onClick={onPrevious} disabled={loading}>
          Previous
        </Button>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {testSuccess && <CheckCircle2 className="w-4 h-4 mr-2" />}
            {loading
              ? 'Connecting...'
              : testSuccess
              ? 'Connected'
